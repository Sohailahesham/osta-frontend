      ...
      ">
        ...
        ">
          ...
          <div className="flex gap-3 sm:gap-4 mb-8 sm:mb-12">
            ...
            >
              <Image src={technicianIcon} alt="Technician" width={32} height={32} />
              ...
              <span className="text-xs text-gray-400 text-center leading-relaxed">
                <span className="hidden sm:inline">قدّم خدماتك للعملاء واستقبل طلبات جديدة في تخصصك</span>
            ...
            >
              ...
              <span className="text-xs text-gray-400 text-center leading-relaxed">
                <span className="hidden sm:inline">اطلب خدمات الصيانة والأعمال المنزلية وتابع طلباتك بسهولة</span>
