...
export default function ServicesHistoryHeroSection() {
  return (
      ...
      <div className="relative z-10 flex items-center justify-start px-8 md:px-16 lg:px-24 pb-16 pt-4">
        <div className="text-right">
          ...
          <p className="max-w-md text-white/80 text-sm md:text-base leading-relaxed">
            هنا تجد سجلاً كاملاً لجميع الخدمات التي قمت بتنفيذها عبر منصة أسطى، مع تفاصيل العميل، الموقع، السعر والتقييم
          </p>
        </div>
      </div>
    </section>
